...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x5b, 0xcc, 0x97, 0x98, 0x00, 0xe4, 0xc4, 0x45, 0x96, 0xb4, 0x47, 0x4a, 0x94, 0x3c, 0x4b, 0x5d}
...
#define IMAI_DATA_OUT_SYMBOLS {"{unlabeled}", "empty_box", "table"}

// data_in [1,65,1] (260 bytes)
#define IMAI_DATA_IN_RANK (3)
#define IMAI_DATA_IN_SHAPE ((int[]){1, 65, 1})
